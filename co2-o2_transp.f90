!Main program for the calculation of transport coefficients in a
!CO2/O2/CO/O/C mixture. Five-temperature model (T, T12, T3, TVO2, TVCO). 
!The program uses modules Constant.f90, Specific_heat.f90, Omega_integrals.f90,
!Bracket_integrals.f90, invers.f90

!Input variables: X(i),T,T12,T3,TVO2,TVCO,press

!Output: heat conductivity coefficient, vibrational heat conductivity coefficients 
!(CO2, combined mode; CO2, asymmetric mode; O2 and CO vibrational heat conductivity);
...
WRITE (6, *) 'Transport properties of CO2/O2/CO/O/C mixture, five-temperature model'
